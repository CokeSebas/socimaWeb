...
//Funciones para rescatar los dartos a colocar en el excel
	function getDatosOrderProcesadas(){
		$link = conectar_mysql();	
...
$results = getDatosOrderProcesadas();
...
if(isset($results)){
	foreach($results as $result){
		...
		$objPHPExcel->getActiveSheet()->setCellValue('A13', utf8_encode('No hay Ordenes Completas'));
		$objPHPExcel->getActiveSheet()->getStyle('A13')->getFont()->setBold(FALSE);
		$objPHPExcel->getActiveSheet()->getColumnDimension('A')->setAutoSize(TRUE);
		$objPHPExcel->getActiveSheet()->getStyle('A13')->getFont()->setSize(12);
		$objPHPExcel->getActiveSheet()->getStyle('A13')->getBorders()->getTop()->setBorderStyle(PHPExcel_Style_Border::BORDER_THIN);
		$objPHPExcel->getActiveSheet()->getStyle('A13')->getBorders()->getLeft()->setBorderStyle(PHPExcel_Style_Border::BORDER_THIN);
}

$filename = 'Ultimas 10 ordenes Completas.xlsx';
