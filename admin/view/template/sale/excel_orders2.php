...
//////////////////////////////////////////////////////////////////
//Funciones para rescatar los dartos a colocar en el excel
	function getDatosOrderProcesadas($order_id){
		$link = conectar_mysql();	
			  		
		$sql = "SELECT o.order_id, o.date_added, c.firstname, c.lastname AS rut, a.address_1, a.city, z.name, o.payment_method, o.comment, o.dcto
...
$result = getDatosOrderProcesadas($order_id);
//var_dump($result);
...
//var_dump(getDatosOrderProcesadas());
//var_dump($datos['payment']);
//var_dump(getOrderProcesadas($datos['order_id']));
//var_dump($ordenes);
...
$x=0;
	...
	if($datos['dcto'] != 0){
		$comentario = $datos['comment'] . ' Tiene un descuento de ' . $datos['dcto'] . '% no aplicado al total.';
	}else{
	...
	$objPHPExcel->getActiveSheet()->setCellValue('C1', 'Fecha : ');
		...
		$objPHPExcel->getActiveSheet()->setCellValue('C4', utf8_encode('Dirección : '));
		...
		$objPHPExcel->getActiveSheet()->setCellValue('C7', utf8_encode('Remisión : '));
		...
		$objPHPExcel->getActiveSheet()->setCellValue('B10', utf8_encode('Código'));
		...
		$objPHPExcel->getActiveSheet()->setCellValue('E10', utf8_encode('Descripción'));
		...
		$objPHPExcel->getActiveSheet()->setCellValue('D8', utf8_encode($comentario));
...
$filename = 'Orden número ' . $datos['order_id'] . '.xlsx';
