...
<div id="content">
  ...
  <div class="box">
    <div class="heading">
      ...
      <div class="buttons"><button id="boton_excel" class="btn btn-small" onclick="excel(<?php echo $_GET['order_id']; ?>)"><img src="view/image/blue-document-excel.png" alt=""> Descargar Excel</button><a href="<?php echo $invoice; ?>" target="_blank" class="button"><?php echo $button_invoice; ?></a><a href="<?php echo $cancel; ?>" class="button"><?php echo $button_cancel; ?></a></div>
    </div>
    <div class="content">
      ...
      <div id="tab-product" class="vtabs-content">
        <table class="list">
		  ...
		  ?>
		<tr>			
			<td colspan="4" class="right"><?php echo "IVA 19%"; ?>:</b></td>
			<td class="right"><?php echo "$".$iva;?></td>	
		  </tr>		  
          <?php foreach ($totals as $totals) { ?>
          <tbody id="totals">
            <tr>
              <td colspan="4" class="right"><?php echo str_replace("Sub-Total", "Valor sin IVA", $totals['title']); ?></td>
              <td class="right"><?php if($totals['code'] == 'sub_total'){ echo "$" . number_format($ValorSinIva,0,',','.'); } else { echo $totals['text'];} ?></td>
            </tr>
          </tbody>
          <?php } ?>
        </table>
...
<script type="text/javascript"><!--
	function excel(order_id){
		var order = order_id;
		//alert('view/template/sale/excel_orders2.php?orderid='+order);
		location.href='view/template/sale/excel_orders2.php?orderid='+order;
	}
