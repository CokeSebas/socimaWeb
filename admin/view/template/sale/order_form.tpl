          ...
          <table class="list">
            ...
            <tbody id="product">
              ...
              <tr id="product-row<?php echo $product_row; ?>">
                ...
                <td class="right"><?php echo number_format($order_product['price'], 0, ',', '.'); ?>
                  <input type="hidden" name="order_product[<?php echo $product_row; ?>][price]" value="<?php echo $order_product['price']; ?>" /></td>
                <td class="right"><?php echo number_format($order_product['total'], 0, ',', '.'); ?>
          ...
          <table class="list">
            ...
            <tbody id="total">
              ...
              <tr>
                ...
                <td class="right"><?php echo '$'.number_format($order_product['price'], 0, ',','.'); ?></td>
                <td class="right"><?php echo '$'. number_format($order_product['total'], 0, ',','.'); ?></td>
              </tr>
              <?php } ?>
              <?php foreach ($order_vouchers as $order_voucher) { ?>
              <tr>
              ...
              <tr id="total-row<?php echo $total_row; ?>">
                ...
                <td class="right"><?php echo '$'.number_format($order_total['value'],0,',','.'); ?></td>
              </tr>
              <?php $total_row++; ?>
              <?php } ?>
              <?php } else { ?>
