...
<div id="content">
  ...
  <?php } ?>
  <div class="box">
    <div class="heading" style="margin: 1px;" >
      <h1> <?php echo $heading_title; ?></h1>
      <div class="buttons">
      		<a onclick="$('form').attr('action', '<?php echo $approve; ?>'); $('form').submit();" class="button"><?php echo $button_approve; ?></a>
      		<a href="<?php echo $insert; ?>" class="button"><?php echo $button_insert; ?></a>
      		<a onclick="$('form').attr('action', '<?php echo $delete; ?>'); $('form').submit();" class="button"><?php echo $button_delete; ?></a></div>
      		<br>
      		<br>
    		<br>
    </div>
          ...
          <!--  <td><select name="filter_approved">
           ...
           <!-- <td><input type="text" name="filter_ip" value="<?php echo $filter_ip; ?>" /></td> -->
            ...
            <!--  <td class="left"><?php echo $customer['approved']; ?></td> -->
              ...
              <td class="left">
              [ <a href="http://socimagestion.com/admin/index.php?route=sale/customer/login&token=<?php echo $token; ?>&customer_id=<?php echo $customer['customer_id']; ?>&store_id=0" target ="_new"><?php echo "Vender"; ?></a> ]
              <?php $_SESSION['Tk'] =  $token; ?>
              </td>
