        ...
        <div id="tab-general">
          ...
          <div id="language<?php echo $language['language_id']; ?>">
            <table class="form">
			  ...
			  <tr>
				<td><span class="required">*</span> <?php echo $entry_imagen; ?></td>
				<td><input type="file" name="information_description[<?php echo $language['language_id']; ?>][imagen]" id="imagen<?php echo $language['language_id']; ?>" size="35" />
					<!--<input name="enviar" type="submit" value="Upload File" />-->
					<input name="action" type="hidden" value="upload" />
					<?php if (isset($error_imagen[$language['language_id']])) { ?>
                  <span class="error"><?php echo $error_imagen[$language['language_id']]; ?></span>
                  <?php } ?></td>
			  </tr>
            </table>
          </div>
