...
class ModelCatalogInformation extends Model {
	public function addInformation($data) {
		...
		$this->db->query("INSERT INTO " . DB_PREFIX . "information SET sort_order = '0', bottom = '0', status = '1'");
	...
	public function get_lastId(){
		$query = $this->db->query("SELECT MAX(information_id) AS id FROM " . DB_PREFIX . "information_description");
		
		return $query->row;
	}
	
	public function save_image($web, $information_id){
		$this->db->query("UPDATE " . DB_PREFIX . "information_description SET imagen = '" . $web . "' WHERE information_id = '" . $information_id . "'");
	}
	
	public function save_banner($url, $information, $banner_id){
		$this->db->query("UPDATE " . DB_PREFIX . "banner2 SET url = '" . $url . "', informacion = '" . $information . "' WHERE banner_id = '" . (int)$banner_id . "'");
	}
	
	public function limpiarBanner($banner_id){
		$this->db->query("UPDATE " . DB_PREFIX . "banner2 SET url = '', informacion = '' WHERE banner_id = '" . $banner_id . "'");
	}

	public function editInformation($information_id, $data) {
		
		$this->db->query("UPDATE " . DB_PREFIX . "information SET sort_order = '0', bottom = '0', status = '1' WHERE information_id = '" . (int)$information_id . "'");
