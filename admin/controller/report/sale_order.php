...
class ControllerReportSaleOrder extends Controller { 
	public function index() {  
		...
		if (isset($this->request->get['filter_date_start'])) {
			$date = new DateTime($this->request->get['filter_date_start']);
			$dateAdded =  $date->format('Y-m-d');
			$filter_date_start = $dateAdded;
		...
		if (isset($this->request->get['filter_date_end'])) {		
			$dateM = new DateTime($this->request->get['filter_date_end']);
			$dateModified =  $dateM->format('Y-m-d');
			$filter_date_end = $dateModified;
