...
class ControllerUserUser extends Controller {
	...
	protected function getForm() {
		...
		$this->data['entry_meta'] = $this->language->get('entry_meta');
		...
		if(isset($this->request->get['user_id'])){
			$email = $this->model_user_user->getEmail($this->request->get['user_id']);
			//var_dump($email['email']);
		}
		if(isset($email['email'])){
			$salesrep = $this->model_user_user->getSalesrepId($email['email']);
			//var_dump($salesrep['salesrep_id']);
		}		
		
		if(isset($salesrep['salesrep_id'])){
			$actual = $this->model_user_user->getActual($salesrep['salesrep_id']);
			if (isset($this->request->post['actual'])) {
				$this->data['actual'] = $this->request->post['actual'];
			} elseif (!empty($user_info)) {
				$this->data['actual'] = $actual['total'];
			} else {
				$this->data['actual'] = '';
			}
		}
		...
		if (isset($this->request->post['meta'])) {
			$this->data['meta'] = $this->request->post['meta'];
		} elseif (!empty($user_info)) {
			$this->data['meta'] = $user_info['meta'];
		} else {
			$this->data['meta'] = '';
		}
		...
		if (isset($this->request->post['localidad'])) {
			$this->data['localidad'] = $this->request->post['localidad'];
		} elseif (!empty($user_info)) {
			$this->data['localidad'] = $user_info['localidad'];
		} else {
			$this->data['localidad'] = '';
		}
