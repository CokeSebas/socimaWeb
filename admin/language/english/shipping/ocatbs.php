...
// Heading
$_['heading_title']    		= 'Total-Based Shipping | <a href="http://opencartaddons.com" target="_blank">OpenCartAddons</a> |';
$_['text_name']    			= 'Total-Based Shipping';
...
$_['help_rate_calculations']	= '
	...
	<tr>
		<td class="left">2. Percentage of Subtotal</td>
		<td class="right">
			<ol type="a">
				<li>Limit: The limit is the higher limit of each range. If your range is 10-20, the limit would be 20</li>
	...
	<tr>
		...
		<td class="right">This is the most complex type of rate out of the three. The formula used to calculate the shipping cost using the calculation method is cost=(d/c)*b
			...
			<div style="border: 1px solid #DDD; text-align: center; margin-top: 5px; width: 75%;">
				<p>Example:</p>
				<p>We are looking to calculate a shipping cost of $0.50 for every $1.00 of in the cart total, as long as the total is less than $10.00. The customer currently has a cart total of $6.00.<br/>
				Rate: 10:0.50/1<br/>
...
$_['help_rate_troubleshoot']			= '
	...
	<p style="font-weight: bold;">
		Email: <a  style="text-decoration: none;" href="mailto:webmaster@opencartaddons.com">webmaster@opencartaddons.com</a></span><br/>
		Skype: <a  style="text-decoration: none;" href="http://skype.com">joelreeds</a>
	</p>
	</div>
