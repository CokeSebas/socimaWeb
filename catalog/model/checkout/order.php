...
class ModelCheckoutOrder extends Model {
	...
	public function get_localidad($user_id){
		$query = $this->db->query("SELECT localidad, name FROM " . DB_PREFIX . "salesrep WHERE user_id = " . $this->db->escape($user_id) . "");

		return $query->row;
	}
	
	public function get_cliente($idCliente){
		$query = $this->db->query("SELECT firstname,lastname, email, telephone, customer_group_id
	...
	public function salesrep($idUser){
		$query = $this->db->query("SELECT salesrep_id
							  FROM " . DB_PREFIX . "salesrep 
