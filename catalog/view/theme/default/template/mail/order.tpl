  ...
  <table style="border-collapse: collapse; width: 100%; border-top: 1px solid #DDDDDD; border-left: 1px solid #DDDDDD; margin-bottom: 20px;">
	...
	<?php 
		...
		include('basededatos.php');
	     ...
	     $vSqlDcto = "SELECT dcto from oc_order where order_id = '" . $order_id . "'";
	     $Resultado =  mysqli_query($vConex,$vSqlDcto);
	     $dcto = "";
	  ...
	  <?php if($dcto != 0){ ?>
		  <tr>
			<td style="font-size: 12px;	border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; text-align: right; padding: 7px;" colspan="4"><b><?php echo "% Dcto Aplicado: "; ?></b></td>
			<td style="font-size: 12px;	border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; text-align: right; padding: 7px;"><?php echo "% " . $dcto; ?></td>
		  </tr>
		  <tr>
			<td style="font-size: 12px;	border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; text-align: right; padding: 7px;" colspan="4"><b><?php echo "Total sin Dcto: "; ?></b></td>
			<td style="font-size: 12px;	border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; text-align: right; padding: 7px;"><?php echo "$ " . number_format($ValorIva2,0,',','.'); ?></td>
		  </tr>
		  <tr>
			<td style="font-size: 12px;	border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; text-align: right; padding: 7px;" colspan="4"><b><?php echo "Valor del Descuento: "; ?></b></td>
			<td style="font-size: 12px;	border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; text-align: right; padding: 7px;"><?php echo "$ " . number_format($valorDelDcto,0,',','.'); ?></td>
		  </tr>
		  <tr>
			<td style="font-size: 12px;	border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; text-align: right; padding: 7px;" colspan="4"><b><?php echo str_replace("Sub-Total", "Valor sin IVA", $totals[0]['title']); ?></b></td>
			<td style="font-size: 12px;	border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; text-align: right; padding: 7px;"><?php if($totals[0]['code'] == 'sub_total'){ echo "$ " . number_format($ValorSinIva,0,',','.'); } else { echo $totals[0]['text'];} ?></td>
		  </tr>
		  <tr>
			<td style="font-size: 12px;	border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; text-align: right; padding: 7px;" colspan="4"><b><?php echo "IVA 19%"; ?>:</b></td>
			<td style="font-size: 12px;	border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; text-align: right; padding: 7px;"><?php echo "$ ".number_format($iva,0,',','.');?></td>	
		  </tr>
		  <tr>
			<td style="font-size: 12px;	border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; text-align: right; padding: 7px;" colspan="4"><b><?php echo str_replace("Sub-Total", "Valor sin IVA", $totals[2]['title']); ?></b></td>
			<td style="font-size: 12px;	border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; text-align: right; padding: 7px;"><?php if($totals[2]['code'] == 'sub_total'){ echo "$ " . number_format($ValorSinIva,0,',','.'); } else { echo "$ " . number_format($totalConDcto ,0,',','.');} ?></td>
		  </tr>
	  <?php } else { ?>
		  <tr>
			<td style="font-size: 12px;	border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; text-align: right; padding: 7px;" colspan="4"><b><?php echo str_replace("Sub-Total", "Valor sin IVA", $totals[0]['title']); ?></b></td>
		  ...
		  <tr>
			<td style="font-size: 12px;	border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; text-align: right; padding: 7px;" colspan="4"><b><?php echo "IVA 19%"; ?>:</b></td>
			<td style="font-size: 12px;	border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; text-align: right; padding: 7px;"><?php echo "$ ".$iva;?></td>	
		  </tr>
		  <tr>
			<td style="font-size: 12px;	border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; text-align: right; padding: 7px;" colspan="4"><b><?php echo str_replace("Sub-Total", "Valor sin IVA", $totals[2]['title']); ?></b></td>
			<td style="font-size: 12px;	border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; text-align: right; padding: 7px;"><?php if($totals[2]['code'] == 'sub_total'){ echo "$ " . number_format($ValorSinIva,0,',','.'); } else { echo "$ " . $ValorIva1;} ?></td>
		  </tr>
	  <?php } ?>
    </tfoot>
  </table>
