<?php echo $header; ?>
  ...
  <!-- end of content -->
<link rel="stylesheet" type="text/css" href="catalog/view/theme/<?php echo $this->config->get('config_template'); ?>/stylesheet/onecheckout-shoppica.css" media="screen" />
<style type="text/css">
...
<?php if (!$logged) { ?> 
	...
	$.ajax({
		...
		dataType: 'json',
		beforeSend: function() {
			$('#payment-address .onecheckout-content').html('<span class="wait">&nbsp;<img src="catalog/view/theme/<?php echo $this->config->get('config_template'); ?>/image/loading.gif" alt="" /></span>');
		},		
		complete: function() {
			$('.wait').remove();
		},
	...
	$.ajax({
		...
		dataType: 'json',
		beforeSend: function() {
			$('#shipping-method .onecheckout-content').html('<span class="wait">&nbsp;<img src="catalog/view/theme/<?php echo $this->config->get('config_template'); ?>/image/loading.gif" alt="" /></span>');
		},		
		complete: function() {
			$('.wait').remove();
		},
...
function registerorguest(){
  ...
  if($('#payment-address input[name=\'account\']:checked').attr('value')){
	$.ajax({
		...
		dataType: 'json',
		beforeSend: function() {
			$('#payment-address .onecheckout-content').append('<span class="wait">&nbsp;<img src="catalog/view/theme/<?php echo $this->config->get('config_template'); ?>/image/loading.gif" alt="" /></span>');
		},		
		complete: function() {
			$('.wait').remove();
		},
...
function shippingaddress(){
	...
	$.ajax({
		...
		dataType: 'json',
		beforeSend: function() {
			$('#shipping-address .onecheckout-content').html('<span class="wait">&nbsp;<img src="catalog/view/theme/<?php echo $this->config->get('config_template'); ?>/image/loading.gif" alt="" /></span>');
		},		
		complete: function() {
			$('.wait').remove();
		},
...
function paymentmethod(countryid, zoneid, isset, city, postcode) {
	$.ajax({
		...
		dataType: 'json',
		beforeSend: function() {
			$('#payment-method .onecheckout-content').html('<span class="wait">&nbsp;<img src="catalog/view/theme/<?php echo $this->config->get('config_template'); ?>/image/loading.gif" alt="" /></span>');
		},		
		complete: function() {
			$('.wait').remove();
		},
...
function confirmorder(){
	$.ajax({
		...
		dataType: 'json',
		beforeSend: function() {
			$('#confirm .onecheckout-content').html('<span class="wait">&nbsp;<img src="catalog/view/theme/<?php echo $this->config->get('config_template'); ?>/image/loading.gif" alt="" /></span>');
		},		
		complete: function() {
			$('.wait').remove();
		},
	...
	$.ajax({
		...
		success: function(json) {
			...
			if (json['output']) {	
				...
				$('#checkout,#confirm .onebuttons,#confirm .cart-module').remove();
...
$('#button-coupon').live('click', function() {
	$.ajax({
		...
		beforeSend: function() {
			...
			$('#button-coupon').after('<span class="wait">&nbsp;<img src="catalog/view/theme/<?php echo $this->config->get('config_template'); ?>/image/loading.gif" alt="" /></span>');
		},
		complete: function() {
...
$('#button-reward').live('click', function() {
	$.ajax({
		...
		beforeSend: function() {
			...
			$('#button-reward').after('<span class="wait">&nbsp;<img src="catalog/view/theme/<?php echo $this->config->get('config_template'); ?>/image/loading.gif" alt="" /></span>');
		},
		complete: function() {
...
$('#button-voucher').live('click', function() {
	$.ajax({
		...
		beforeSend: function() {
			...
			$('#button-voucher').after('<span class="wait">&nbsp;<img src="catalog/view/theme/<?php echo $this->config->get('config_template'); ?>/image/loading.gif" alt="" /></span>');
		},
		complete: function() {
...
$('#confirmorder #button-confirm').live('click', function() {
	...
	$('#confirmorder #button-confirm').after('<span class="wait">&nbsp;<img src="catalog/view/theme/<?php echo $this->config->get('config_template'); ?>/image/loading.gif" alt="" /></span>');
});
  ...
  $('.warning').fadeIn('slow');	
	...
	$.ajax({
		...
		beforeSend: function() {
			...
			$('#button-confirmorder').after('<span class="wait">&nbsp;<img src="catalog/view/theme/<?php echo $this->config->get('config_template'); ?>/image/loading.gif" alt="" /></span>');
		},		
		success: function(json) {
			$('.success, .warning').remove();	
