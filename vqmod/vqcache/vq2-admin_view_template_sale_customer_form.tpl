...
<div id="content">
  ...
  <div class="box">
			...
			<div class="heading"><h1><img src="view/image/admin_theme/base5builder_circloid/icon-customers.png" alt="<?php echo $heading_title; ?>" width="32" height="32" /> <?php echo $heading_title; ?></h1>
    ...
    <div class="content">
      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <div id="tab-general">
          ...
          <div id="tab-customer" class="vtabs-content">
            <table class="form">
              ...
              <tr>
                <td><?php echo "Latitudes <small><br>Ej:[\"-33.0263054\", \"-71.5517021\"]</small>"; ?></td>
			  ...
			  <tr>
                ...
                <td><?php echo $entry_vendedor; ?></td>
                <td><select name="vendedor">
                    <?php foreach($vendedores as $salesrep){ 
					if($vendedor == $salesrep['salesrep_id']) { ?>
			  ...
			  <tr>
                <td><?php echo $entry_credit_total; ?></td>
                <td><input type="text" name="creditoMaximo" value="<?php echo number_format($creditoMaximo,0,',','.'); ?>" /></td>
              </tr>
			  <tr>
                <td><?php echo $entry_credit_actual; ?></td>
                <td><input type="text" name="creditoActual" value="<?php echo number_format(($creditoMaximo - $creditoActual),0,',','.'); ?>" /></td>
              </tr>
            </table>
          </div>
          <?php $address_row = 1; ?>
		...
		<div id="tab-transaction">
			<table class="form">
            <tr>
              <td>Ordenes completas y despachadas</td>
			 </tr>
			</table>
			<table class="list">
          <thead>
