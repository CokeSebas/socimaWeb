...
class ModelAccountCustomer extends Model {
	...
	public function getCredito($id_customer){
		//$query = $this->db->query("SELECT customer_id, firstname, Credito FROM " . DB_PREFIX . "customer WHERE customer_id = " . (int)$id_customer);
		$query = $this->db->query("SELECT customer_id, firstname, CreditoMaximo AS Credito FROM " . DB_PREFIX . "customer WHERE customer_id = " . (int)$id_customer);
	//var_dump("SELECT customer_id, firstname, Credito FROM " . DB_PREFIX . "customer WHERE customer_id = " . (int)$id_customer);
		return $query->rows;
	}
